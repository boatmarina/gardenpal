    ...
    try:
        ...
        resp = client.messages.create(
            ...
            system=(
                ...
                "NOT_NEEDED means fertilizing would be actively harmful or truly provide zero benefit. "
                "Reserve it for: plant is dead or dying, plant has completely finished its productive life "
                "(e.g. annual that has fully senesced), or fertilizer would directly harm it "
                "(e.g. excess nitrogen causing root vegetables like carrots/beets to fork).\n"
                "IMPORTANT — 'days to maturity' does NOT mean the plant is done. For fruiting crops "
                "(tomatoes, peppers, cucumbers, squash, beans, etc.) 'days to maturity' means first "
                "harvest — these plants continue producing and benefit from ongoing fertilization for "
                "weeks or months afterward. Never use NOT_NEEDED just because a plant has reached its "
                "days-to-maturity milestone or is actively fruiting/harvesting.\n"
                ...
                "CRITICAL: If the next application was already due (today is past last_fertilized + INTERVAL_DAYS), "
                "return TODAY'S DATE on Line 1. Do not skip to the next cycle date. "
                "The user missed the window — they should fertilize now, not wait another full interval.\n"
                "Reply with ONLY:\n"
